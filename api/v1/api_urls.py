...
#     OrganizationViewSet, ChurchViewSet, MissionOrganizationViewSet,
#     ChristianPublishingHouseViewSet, ChristianWorshipMinistryViewSet,
#     ChristianCounselingCenterViewSet, ChristianConferenceCenterViewSet,
...
# from apps.sanctuary.views import SanctuaryReviewViewSet, SanctuaryRequestViewSet
...
# # === final urlpatterns ===
# urlpatterns = [
#     # Per-app routers (modular)
#     path('', include('apps.posts.urls')),         # includes /me/testimonies and other posts routes
#     path('', include('apps.profilesOrg.urls')),   # organizations & related resources
#     path('', include('apps.sanctuary.urls')),     # sanctuary routes (root + nested inside the app)
# ] + router.urls \
#   + members_router.urls \
