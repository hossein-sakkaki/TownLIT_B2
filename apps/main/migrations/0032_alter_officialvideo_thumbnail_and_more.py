...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0031_officialvideo_parent_alter_officialvideo_thumbnail_and_more'),
    ]
