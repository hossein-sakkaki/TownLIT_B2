...
import utils.storage.image_conversion_storage
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0034_alter_officialvideo_thumbnail_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='screenshot',
            field=models.ImageField(blank=True, null=True, storage=utils.storage.image_conversion_storage.HEICToJPEGStorage(), upload_to=utils.common.utils.FileUpload.dir_upload, validators=[validators.mediaValidators.image_validators.validate_image_file, validators.mediaValidators.image_validators.validate_image_size, validators.security_validators.validate_no_executable_file], verbose_name='Document'),
        ),
    ]
