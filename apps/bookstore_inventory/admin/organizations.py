...
class OrganizationProfileLinkInline(
    admin.TabularInline
):
...
class OrganizationRecordAdmin(
    ...
    def usage_summary(self, obj):
        ...
        return (
            f"Books published: "
            f"{obj.published_books.count()} | "
            f"Editions published: "
            f"{obj.published_editions.count()} | "
            f"Editions printed: "
            f"{obj.printed_editions.count()} | "
            f"Shipments supplied: "
            f"{obj.supplied_shipments.count()} | "
            f"Shipments donated: "
            f"{obj.donated_shipments.count()} | "
            f"Orders received: "
            f"{obj.book_orders_received.count()}"
        )


@admin.register(OrganizationProfileLink)
class OrganizationProfileLinkAdmin(
    HiddenFromAdminIndexMixin,
    WorkflowAdminMixin,
    admin.ModelAdmin,
):
    ...
    search_fields = (
        "organization__official_name",
        "organization__aliases__name",
        "=object_id",
        "evidence",
    )
    autocomplete_fields = (
