...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0036_userdevicekey_fcm_token_userdevicekey_platform_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userdevicekey',
            name='push_token',
            field=models.CharField(blank=True, help_text='Universal push registration token (FCM/WebPush/APNs)', max_length=512, null=True),
        ),
