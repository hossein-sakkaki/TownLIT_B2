...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0089_alter_customuser_image_name'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(choices=[('believer', 'I follow Jesus (Believer)'), ('seeker', 'I’m exploring faith (Seeker)'), ('prefer_not_to_say', 'I’d prefer not to say'), ('young_path', 'TownLIT Young Path — Coming Soon')], max_length=20, unique=True, verbose_name='Label Name'),
        ),
        migrations.AlterField(
