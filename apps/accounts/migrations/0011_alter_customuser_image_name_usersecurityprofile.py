# Generated by Django 4.2.4 on 2025-08-10 02:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kdf', models.CharField(default='PBKDF2', max_length=20)),
                ('iterations', models.IntegerField(default=600000)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='sec_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
