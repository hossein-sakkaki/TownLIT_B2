    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_phone_number', models.CharField(blank=True, max_length=20, null=True, unique=True, validators=[common.validators.validate_phone_number], verbose_name='Phone Number')),
                ...
                ('license_document', models.FileField(blank=True, null=True, upload_to=utils.common.utils.FileUpload.dir_upload, validators=[common.validators.validate_pdf_file, common.validators.validate_no_executable_file], verbose_name='License Document')),
                ('license_expiry_date', models.DateField(blank=True, null=True, verbose_name='License Expiry Date')),
                ('logo', models.ImageField(default='media/sample/logo.png', upload_to=utils.common.utils.FileUpload.dir_upload, validators=[common.validators.validate_image_or_video_file, common.validators.validate_no_executable_file], verbose_name='Logo')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='accounts.organizationservice', verbose_name='Organization Services'),
        ),
        migrations.AddField(
            model_name='organization',
