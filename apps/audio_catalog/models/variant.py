...
class MusicTrackVariant(
    ...
    is_offline_eligible = models.BooleanField(default=False)
    ...
    def _media_changed(self):
        return (
            getattr(self.audio_file, "name", None)
    ...
    def can_deliver_asset(
        ...
        *,
        ...
        if intent == "offline":
            ...
            return can_offline_play_track(
                self.track,
                variant=self,
            ).allowed

        if intent == "download":
            return can_download_track(
                self.track,
                variant=self,
            ).allowed

        return can_stream_track(self.track).allowed
