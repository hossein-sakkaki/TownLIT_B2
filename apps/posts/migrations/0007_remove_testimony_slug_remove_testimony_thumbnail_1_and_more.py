# Generated by Django 4.2.4 on 2025-09-09 17:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='testimony',
            name='type',
            field=models.CharField(choices=[('audio', 'Audio'), ('video', 'Video'), ('written', 'Written')], db_index=True, default=1, max_length=10, verbose_name='Type'),
        ...
        migrations.AddConstraint(
            model_name='testimony',
            constraint=models.UniqueConstraint(fields=('content_type', 'object_id', 'type'), name='uniq_owner_type_testimony'),
        ),
    ]
