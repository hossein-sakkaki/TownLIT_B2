...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0041_testimony_comments_count_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='last_viewed_at',
            field=models.DateTimeField(blank=True, null=True, verbose_name='Last Viewed At'),
        ),
        migrations.AddField(
            model_name='testimony',
            name='view_count_internal',
            field=models.PositiveIntegerField(default=0, verbose_name='Internal View Count'),
        ),
