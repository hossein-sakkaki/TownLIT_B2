# Generated by Django 4.2.4 on 2026-07-16 06:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0077_testimony_audio_artwork_alter_announcement_image_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DateTimeField(blank=True, db_index=True, help_text='Persistent marker preventing the original Moment publication notification from being dispatched more than once.', null=True, verbose_name='Publication Notification Dispatched At'),
        ),
