...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='comment',
            field=django_cryptography.fields.encrypt(models.TextField(blank=True, null=True, verbose_name='Comment')),
        ),
        migrations.AlterField(
            model_name='comment',
            name='object_id',
        ...
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['content_type', 'object_id'], name='posts_comme_content_804eed_idx'),
        ),
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['recomment'], name='posts_comme_recomme_92ba06_idx'),
        ),
    ]
