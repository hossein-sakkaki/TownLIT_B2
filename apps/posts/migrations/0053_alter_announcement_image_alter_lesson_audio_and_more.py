...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='moment',
            name='visibility',
            field=models.CharField(choices=[('global', 'Global (Public)'), ('friends', 'Friends only'), ('covenant', 'LIT Covenant'), ('private', 'Only me')], db_index=True, default='global', max_length=20, verbose_name='Visibility'),
        ),
        migrations.AlterField(
            model_name='pray',
            name='image',
