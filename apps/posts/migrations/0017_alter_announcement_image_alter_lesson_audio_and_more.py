...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='reaction',
            name='message',
            field=models.CharField(blank=True, max_length=100, null=True, verbose_name='Reaction Message'),
        ),
        migrations.AlterField(
            model_name='reaction',
            name='reaction_type',
            field=models.CharField(choices=[('like', 'Like'), ('bless', 'Bless'), ('gratitude', 'Gratitude'), ('amen', 'Amen'), ('encouragement', 'Encouragement'), ('empathy', 'Empathy'), ('faithfire', 'FaithFire'), ('support', 'Support')], max_length=20, verbose_name='Reaction Type'),
        ),
        migrations.AlterField(
        ...
        migrations.AddIndex(
            model_name='reaction',
            index=models.Index(fields=['content_type', 'object_id'], name='posts_react_content_48b564_idx'),
        ),
        migrations.AddIndex(
            model_name='reaction',
            index=models.Index(fields=['name', 'content_type', 'object_id'], name='posts_react_name_id_7e7f72_idx'),
        ),
    ]
