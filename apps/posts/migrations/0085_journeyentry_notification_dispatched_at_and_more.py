# Generated by Django 4.2.4 on 2026-08-24 02:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0084_journeyentry_rendered_video_alter_announcement_image_and_more'),
    ]

    operations = [
        migrations.AddField(
            model_name='journeyentry',
            name='notification_dispatched_at',
        ...
        migrations.AddConstraint(
            model_name='journeyentry',
            constraint=models.UniqueConstraint(fields=('composition_public_id_snapshot', 'composition_revision'), name='journey_unique_composition_revision'),
        ),
    ]
