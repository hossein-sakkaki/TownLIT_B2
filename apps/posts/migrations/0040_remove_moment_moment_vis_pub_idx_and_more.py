...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0039_remove_moment_posts_momen_content_60957d_idx_and_more'),
    ]

    operations = [
        migrations.RemoveIndex(
            model_name='moment',
            name='moment_vis_pub_idx',
        ),
        migrations.AddField(
            model_name='moment',
            name='comments_count',
        ...
        migrations.AddIndex(
            model_name='moment',
            index=models.Index(fields=['visibility', '-published_at', '-id'], name='moment_vis_pub_id_idx'),
        ),
    ]
