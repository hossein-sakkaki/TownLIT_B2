...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0019_alter_announcement_image_alter_comment_comment_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='reaction',
            name='message',
            field=django_cryptography.fields.encrypt(models.TextField(blank=True, null=True, verbose_name='Reaction Message')),
        ),
        migrations.AlterField(
