...
from apps.config.accounts_constants import (
    SOCIAL_MEDIA_CHOICES, SOCIAL_MEDIA_DATA
)
...
# Import Gift
from .gift_constants import GIFT_LANGUAGE_CHOICES
...
from apps.config.store_constants import (
