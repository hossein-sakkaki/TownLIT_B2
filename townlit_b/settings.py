...
from townlit_b.settings_env import (
    env_bool,
    env_float,
    env_int,
    env_list,
...
INSTALLED_APPS = [
    ...
    # Universal mixed-content stream.
    "apps.core.streams.apps.StreamsConfig",

    # Dedicated Journey-only stream.
    "apps.core.journey_streams.apps.JourneyStreamsConfig",
    "apps.journey_insights.apps.JourneyInsightsConfig",
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'townlit_local_static'),
]
...
# Audio Analytics config ----------------------------------------------------------------
AUDIO_ANALYTICS = {
    "heartbeat_interval_seconds": 15,
    "heartbeat_tolerance_ms": 5000,
    "max_heartbeat_delta_ms": 30000,

    "qualified_min_listen_ms": 10000,
    "qualified_min_percent": 0.25,
    "completion_percent": 0.90,
    "early_skip_max_ms": 5000,

    "stale_session_minutes": 30,
    "raw_session_retention_days": 90,

    "trending_window_days": 7,
    "trending_half_life_days": 3.0,
